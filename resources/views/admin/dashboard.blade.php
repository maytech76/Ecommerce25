                    ...
                    <div class="custome-1-bg b-r-4 card-body">
                        <div class="media align-items-center static-top-widget">
                            <div class="media-body p-0">
                                <span class="m-0">Total Devoluciones</span>
                ...
                <div class="main-tiles border-5 card-hover border-0 card o-hidden">
                    <div class="custome-2-bg b-r-4 card-body">
                        <div class="media static-top-widget">
                            <div class="media-body p-0">
                                <span class="m-0">Total de Ordenes</span>
                    ...
                    <div class="card-body p-0">
                        <div class="category-slider no-arrow">
                            ...
                            <div>
                                <div class="dashboard-category">
                                    <a href="javascript:void(0)" class="category-image">
                                        {{-- <img sr{{ asset('admin/svg/pet.svg') }}" class="img-fluid" alt=""> --}}
                                    </a>
                                    <a href="javascript:void(0)" class="category-name">
                                        <h6>Pet Food</h6>
                                    </a>
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="best-product-box">
                                                    <div class="product-image">
                                                        {{-- <img src="{{ asset('admin/images/product/1.png') }}" class="img-fluid" alt="Product"> --}}
                                                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="best-product-box">
                                                    <div class="product-image">
                                                        {{-- <img src="{{ asset('admin/images/product/2.png') }}" class="img-fluid" alt="Product"> --}}
                                                    </div>
                                                    <div class="product-name">
                                                        <h5>Aata Buscuit</h5>
                                                        <h6>26-08-2022</h6>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="best-product-box">
                                                    <div class="product-image">
                                                        {{-- <img src="{{ asset('admin/images/product/3.png') }}" class="img-fluid" alt="Product"> --}}
                                                    </div>
                                                    <div class="product-name">
                                                        <h5>Aata Buscuit</h5>
                                                        <h6>26-08-2022</h6>
