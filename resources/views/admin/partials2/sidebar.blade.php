<div class="sidebar-wrapper">
    ...
    <div>
        ...
        <div class="logo-icon-wrapper">
            <a href="index.html">
                <img class="img-fluid main-logo main-white" src="../public/admin/images/logo/logo.png" alt="logo">
                <img class="img-fluid main-logo main-dark" src="../public/admin/images/logo/logo-white.png" alt="logo">
            </a>
        </div>
